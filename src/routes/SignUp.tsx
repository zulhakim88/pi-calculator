        ...
        <form onSubmit={handleFormSubmit} className="w-full">
          <div className="flex flex-row justify-between gap-3">
            ...
            <div className="flex flex-col py-2 w-60">
              ...
              <input onChange={handleInput} className="border p-3 rounded-lg" type="text" name="lastName" placeholder="Last Name..." />
            </div>
          </div>
          <div className="flex flex-col py-2">
            <label className="py-2 font-medium">Email Address</label>
            <input onChange={handleInput} className="border p-3 rounded-lg" type="email" name="email" placeholder="Email..." />
          </div>
          <div className="flex flex-col py-2">
            <label className="py-2 font-medium">Password</label>
            <input onChange={handleInput} className="border p-3 rounded-lg" type="password" name="password" placeholder="Password..." />
          </div>
          <div className="flex flex-col py-2">
            <label className="py-2 font-medium">Confirm Password</label>
            <input onChange={handleInput} className="border p-3 rounded-lg" type="password" name="confirmPassword" placeholder="Confirmed Password..." />
          </div>
          {
            loading ?
