...
const PiCalculator = (): JSX.Element => {
    ...
    return (
        <>
            ...
            <textarea className="p-4 w-full bg-gray-200 rounded-md resize-none border-solid border-2 border-gray-400" cols={100} rows={6} value={piValue} disabled></textarea>
        </>
    )
}
